Public Class Bons_de_livraison
    Private Sub Bons_de_livraison_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    End Sub

    Private Sub Bons_de_livraison_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
