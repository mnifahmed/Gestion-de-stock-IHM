Public Class Factures_d_Achat
    Private Sub Factures_d_Achat_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    End Sub

    Private Sub Factures_d_Achat_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
